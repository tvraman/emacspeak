...
pactl load-module module-ladspa-sink sink_name=FURight plugin=ZamHeadX2-ladspa label=ZamHeadX2 control=315,45,2.5
...
pactl load-module module-ladspa-sink sink_name=FLRight plugin=ZamHeadX2-ladspa label=ZamHeadX2 control=315,-45,2.5
