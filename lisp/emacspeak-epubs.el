;;; emacspeak-epubs.el --- epubs Front-end for emacspeak desktop
;;; $Id: emacspeak-epubs.el 5798 2008-08-22 17:35:01Z tv.raman.tv $
;;; $Author: tv.raman.tv $
...
(defgroup emacspeak-epubs nil
  "Epubs Digital  Books  for the Emacspeak desktop."
  :group 'emacspeak)

;;}}}

(provide 'emacspeak-epubs)
;;{{{ end of file
