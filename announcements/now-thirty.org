* Introduction
  ...
  2. Emacspeak at 20 was published in September 2014 to trace the
  ...
  4. In the process, we identify the dreams that have come to pass as
     ...
     of developments in the larger  Internet world we live in.
  5. But never fear, though some of the above might be superficially
     ...
     things to come.
  6. As a proof-point, in 1994, I  could not have   imagined the
     impact 
     that the world of Internet-centric computing and the accompanying
     information revolution  has had on the state of information access.
  7. Share And Enjoy --- The Best Is Yet To Come!
