* Introduction
  ...
  2. The goal was to create a system for daily use that also doubled
     ...
     where speech and auditory output were treated as 
...
*  Using UNIX With Speech Output —  2024
  ...
  5. As with other platforms, native applications are mostly gone bar the
     shouting. In that context, where the majority of users access 
...
* Emacspeak And Software Development
  ...
  7.  Developing in languages like Python (~elpy~), ~R~,
  ...
  9. [[https://emacspeak.blogspot.com/2023/09/emacs-ergonomics-dont-punish-your.html][Ergonomic keybindings]] under ~X~ using [[https://github.com/alols/xcape][xcape]] to minimize
...
* Emacspeak  And The Web In 2024
  ...
  6. In this context, see [[https://idlewords.com/talks/website_obesity.htm][Tag Soup, Scripts And Obfuscation: How The
  ...
  12. Web APIs come and go, usually  last for a few years, so in some
...
new     enhancements  supporting more TTS engines.
  ...
  5. Enabling virtual sound devices via Pipewire for 5.1  and 7.1
     binaural audio significantly enhances the auditory experience.
...
* The RESTful Web —  Web Wizards And URL Templates For Faster Access
  ...
  2. Twenty years on (this feature originally landed in 2000)
     ...
     and post-processors that enables ever-more powerful Web
...
* Mashing It Up —  Leveraging  AI And The Web 
  ...
  1.  Developing solutions by combining various
   ...
   to commit fully to the JS-powered Web hosted in a Web browser,
