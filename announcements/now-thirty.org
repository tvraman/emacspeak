...
* Conclusion
  ...
  1. Open systems are a key prerequisite for developing new access paradigms.
  2. This is not mere idealism.  Openness is a key enabler for
     creating  new user journeys that were not  envisioned by the
     system's creators.
  3. Emacs is a great example of a system that permits maximal freedom
      from the viewpoint of user extensibility and creativity.
  ...
  7. /Ease of use/ in of itself is often /marketing/. Useful systems
     are fun to learn and give more than what you put in with respet
     to time and effort.
