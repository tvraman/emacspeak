...
* Introduction
  ...
  4. The time felt right with respect to building such a system 
     enabled  equal access to the emerging Web of Internet content.
  ...
  8. But never fear, though  some of the above might
     seem  superficially
