...
media content.
\end{enumerate}
3Emacspeak . speech-enables \texttt{Calibre} integration for working with  local
   electronic  libraries.
\section{Leveraging Computational Tools —  From SQL And R To IPython Notebooks}
\label{sec:orgd9f479d}
...
\end{enumerate}
\section{Social Web  — Mail, Instant Messaging And Blogging}
\label{sec:orgbbf314b}
