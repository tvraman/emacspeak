...
engine. The values used in property _personality_ were abstract,
i.e., they were independent of any given speech engine. Later in
the fall of 1995, I re-expressed these set of abstract voice
...
stood the test of time in that as we added support for more TTS
engines, we were able to implement engine-specific mappings of
Aural-CSS values. This meant that the rest of Emacspek could
...
** Social Web: EMail,Instant Messaging And Blogging  Using Open Protocols 
