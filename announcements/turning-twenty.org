...
Emacspeak will see that that was just scratching the surface.
  ...
  - Ability to move through diff chunks when working with source
    ...
    by the _ediff_ package when speech-enabled is a major
    productivity win.
...
formed part of the [[http://www.w3.org/MarkUp/Forms/][XForms]]  work at the W3C.
...
was later formalized by [[https://www.bookshare.org/#mainContent][BookShare]] — today, qualified users can
...
In 1996, I wrote an article entitled [[http://www.drdobbs.com/user-interface-a-means-to-an-end/184410453][User Interface — A Means To
...
touch screen. The next generation in the evolution of *personal*
