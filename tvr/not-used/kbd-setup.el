...
(define-key function-key-map "\e[Q" [(silence)])
(define-key function-key-map"\e[P" '[pause])                
(define-key function-key-map "\e[S" [(search)])
...
(define-key function-key-map [(control \;)] "\C-x@H")
...
(define-key function-key-map "\e\e[C" [27 right])
